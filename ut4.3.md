# UT4.3 Diseño de interfaces. Prototipos en Figma
...
El diseño de una aplicación, tanto funcional como gráfico, ha de responder a las características definidas en un proceso de análisis.
- Los **elementos de diseño** que van a formar partede nuestra aplicación. Debe haber un número suficiente, pero sin que haya saturación de estos.
- La extensión de la aplicación.
-Patrones de diseño que van a utilizarse para estandarizar el diseño de interfaces.
- Aspectos técnicos de **usabilidady** **accesibilidad**. Se seguirá ampliando en próximas unidades.
...
Una vez que se ha definido la estructura de la aplicación, se documenta mediante sketchingy wireframeso diagramas. El diagrama debe describir la macroestructura con el detalle adecuado, para que los miembros del equipo de producción puedan compartir una visión general. El detalle específico de cada página, o microestructura, debe ser descrito en otros documentos técnicos más adelante.
...
El **diseño de la retícula** está formando parte de la definición de los elementos principales del diseño (colory tipografía). La retícula se utiliza para establecer una estructura de diseño continua y coherente en soportes que deban alojar todo tipo de contenidos.
...
#### Diseño visual: elementos interfaz

A partir de la división y asignación de espacios de pantalla, se concretan los principales elementos de la interfaz, que incluyen:
...
Durante esta fase se lleva a cabo una **evaluación de la usabilidad**, que ya vimos, así como un estudio de la accesibilidadde la aplicación o la web. Se estudiará de forma más detallada en unidades posteriores.
...
En el apartado de *community* tenemos plantillas con componentes muy interesantes para reutilizar en nuestros proyectos como: Material UI for Figma, Glow UI, Untitled UI, Bootstrap 5 UI, iOS components, Windows 11 UI Kit,
...
- [**Canva** ](https://www.canva.com/) para crear gráficos y diseños de forma sencilla: